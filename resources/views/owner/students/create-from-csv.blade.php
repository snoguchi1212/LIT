<x-app-layout>
    ...
    <div class="py-4">
        ...
        <div class="p-6 bg-white border-b border-gray-200">
            ...
            <form method="POST" action="{{ route('owner.students.storeFromCSV') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mt-4 p-2 w-full flex justify-around">
                    <button type="button" onclick="location.href='{{ route('owner.students.create') }}'" class=" text-white bg-gray-500 border-0 py-2 px-8 focus:outline-none hover:bg-gray-600 rounded text-lg">戻る</button>
