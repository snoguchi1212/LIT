                        ...
                        <div class="container px-5 mx-auto">
                            ...
                            @csrf
                                <div class="p-2 -m-2 w-2/4">
                                    ...
                                    <div>
                                        <select id="sex" name="sex">
                                            ...
                                            <option value="{{ $number }}" @if($teacher->sex===$number) selected @endif>{{ $name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="family_name" name="family_name" value="{{ $teacher->family_name }}" required class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                </div>
                                </div>
                                <div class="p-2 w-1/2">
                                <div class="relative">
                                    <label for="first_name" class="leading-7 text-sm text-gray-600">名</label>
                                    <input type="text" id="first_name" name="first_name" value="{{ $teacher->first_name }}" required class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                </div>
                                </div>
                            </div>
                            <div class="flex flex-wrap -m-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="family_name_kana" name="family_name_kana" value="{{ $teacher->family_name_kana }}" pattern="[\u30A1-\u30FC]*" title="全角カタカナ" required class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                </div>
                                </div>
                                <div class="p-2 w-1/2">
                                <div class="relative">
                                    <label for="first_name_kana" class="leading-7 text-sm text-gray-600">メイ</label>
                                    <input type="text" id="first_name_kana" name="first_name_kana" value="{{ $teacher->first_name_kana }}" pattern="[\u30A1-\u30FC]*" title="全角カタカナ" required class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                </div>
                                </div>
                            </div>
                            <div class="p-2 -m-2">
                                <label for="email" class="leading-7 text-sm text-gray-600">メールアドレス</label>
                                <input type="email" id="email" name="email" value="{{ $teacher->email }}" required class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            </div>
