                        ...
                        <div class="container px-5 mx-auto">
                            ...
                            <div class="lg:w-10/12 w-full mx-auto overflow-auto">
                                <div class="flex">
                                    <div class="mb-4">
                                        {{-- iconを入れる --}}
                                        <button onclick="location.href='{{ route('student.tests.index', [$student->id]) }}'" class="text-white bg-sky-400 border-0 py-2 px-4 focus:outline-none hover:bg-sky-500 rounded text-lg">テストごと</button>
                                    </div>
                                </div>
                            {{-- TODO:レスポンシブ対応 --}}
